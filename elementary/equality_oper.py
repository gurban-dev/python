...
# Python is case sensitive when it comes to comparing strings.

# "venice" and "VENICE" are not equal to each other because the
# case of the letter (upper case or lower case) matters.
...
# "1" == 1 evaluates to False because Python first compares the data
# types.
...
# A "\n" (newline escape sequence) forces the output to appear one
# line below.
print("\n\"1\" == 1:", "1" == 1)
