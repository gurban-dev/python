...
for outer in range(2):
    ...
    # The inner for loop will loop two times
    # for each of the outer loop's iterations.
    for inner in range(1):
        print("inner:", inner)

        iteration_count += 1

    # For the following print statement to be executed on
    # each iteration in the outer loop, it must be indented
    # four spaces to the right of the start of the outer for
    # loop statement.   
