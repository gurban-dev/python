...
print('After assigning \'num1\' to \'num2\':')
...
# Adding .0 also changes the identity of 'num2' because adding a float
# to an integer results in a float object. 'num2' references a float
# after this operation.
num2 += .0

print('After adding to \'num2\':')
print('id(num1):', id(num1))
print('id(num2):', id(num2), '\n')
...
print('Before concatenating \" world\" to \'greeting\':')
...
print('After concatenating \" world\" to \'greeting\':')
print('id(hello):', id(hello))
print('id(greeting):', id(greeting), '\n')
